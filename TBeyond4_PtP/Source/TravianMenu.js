//////////////////////////////////////////////////////////////////////
// returns menu as object { menu:menu_parent_DOM_node, active:idx, items:[[txt1,href1,onlygold],...,[txtN,hrefN,onlygold]] }
function __searchAndParseMenu(aDoc,cls)
{
   ...
   __ASSERT__(ssMenu.snapshotLength > 0, "Can't find '"+ cls +"'menu tabs!")
