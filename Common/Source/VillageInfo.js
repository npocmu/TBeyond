...
function VillageInfo() 
{
   ...
   IF_TB3(this.upai = new UpgradeInfo();)  // blacksmith upgrades
...
IF_TB3({{
function xVillage(aName, vID, newdid, x, y, vLink)
{
   this.vName = aName;
   this.vID = vID;
   this.vNewdid = newdid;
...
/////////////////////////////////////////////////////////////////////
function initVillageInfo(info, village) 
{
   info.name = village.vName;
   info.id = village.vNewdid;
   info.x = village.vx; 
   info.y = village.vy;
}
}})
...
//////////////////////////////////////////////////////////////////////
// TODO: need to compare ttUpd from building info and cp info
